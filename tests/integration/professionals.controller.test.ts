...
describe('ProfessionalsController', () => {
  ...
  describe('GET /professionals/:id', () => {
    ...
    it('should return 404 if the professional does not exist', async () => {
      const response = await request(app)
        .get(`/professionals/non-existent-professional-id`)
        .set({
          Authorization: `Bearer ${accessToken}`,
        });
  ...
  describe('PATCH /professionals/:id', () => {
    ...
    it('should return 404 if the professional does not exist', async () => {
      const response = await request(app)
        .patch(`/professionals/non-existent-professional-id`)
        .set({
          Authorization: `Bearer ${accessToken}`,
        })
        .send({
  ...
  describe('DELETE /professionals/:id', () => {
    it('should return 200 and delete a professional', async () => {
      const response = await request(app)
        .delete(`/professionals/${professional.id}`)
        .set({
          Authorization: `Bearer ${accessToken}`,
        });
    ...
    it('should return 404 if the professional does not exist', async () => {
      const response = await request(app)
        .delete(`/professionals/non-existent-professional-id`)
        .set({
          Authorization: `Bearer ${accessToken}`,
        });
