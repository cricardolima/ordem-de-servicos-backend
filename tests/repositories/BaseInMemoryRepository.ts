export abstract class BaseInMemoryRepository<T> {
    ...
    protected findByProperty<K extends keyof T>(
        property: K, 
        value: T[K]
    ): T | undefined {
    ...
    protected findAllByProperty<K extends keyof T>(
        property: K, 
        value: T[K]
    ): T[] {
    ...
    protected updateByProperty<K extends keyof T>(
        property: K, 
        value: T[K], 
        updates: Partial<T>
    ): boolean {
    ...
    protected removeByProperty<K extends keyof T>(
        property: K, 
        value: T[K]
    ): boolean {
